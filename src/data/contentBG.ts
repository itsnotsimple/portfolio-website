...
export const SITE_CONFIG = {
  ...
  subTagline: 'AP Media (Alex | Video Editor) — професионален видео редактор, специализиран в рекламни кампании, брандинг и вайръл съдържание за социални медии.',
...
export const ABOUT = {
  ...
  paragraphs: [
    'AP Media (Alex | Video Editor / Alex Media) е премиум студио за видео монтаж с над 3 години опит в създаването на ангажиращо, вдъхновяващо и продаващо съдържание. Специализирам в дигиталното разказване на истории — от рекламни бранд кампании до кратки вайръл клипове.',
    'Като APMEDIA, работя с популярни инфлуенсъри, брандове и креативни агенции в България и Европа. Всеки видео проект получава безкомпромисно внимание към детайла.',
  ],
  tools: [
    'Premiere Pro',
    'After Effects',
...
export const REVIEWS_SECTION = {
  ...
  satisfactionRate: 'Доволни клиента',
  availableLabel: 'Работи с мен',
  ratingFrom: 'от',
...
export const FAQ_ITEMS: FAQItem[] = [
  {
    ...
    answer: 'В AP Media специализирам в рекламни кампании, музикални клипове, съдържание за социални медии (Reels, TikTok, Shorts), корпоративни бранд видеа, документални филми за пътувания и продуктови реклами. Ако имаш уникален проект, нека поговорим — AP Media (Alex | Video Editor) обича творческите предизвикателства.',
  },
  {
    id: 'faq-2',
    question: 'Колко време отнема един типичен проект?',
    answer: 'Като опитен видео монтажист, времето за изработка в AP Media зависи от обема на проекта. Кратките клипове за социални медии обикновено отнемат 1–2 работни дни. За по-големи проекти се споразумяваме за сроковете предварително.',
  },
  {
    id: 'faq-3',
    question: 'Какъв софтуер използваш?',
    answer: 'Основните инструменти на AP Media за видео обработка и ефекти са Adobe Premiere Pro, After Effects и CapCut Pro.',
  },
  {
    id: 'faq-4',
    question: 'Колко ревизии (корекции) са включени?',
    answer: 'Всички проекти, поверени на AP Media, включват стандартно 3 кръга от корекции. Това обхваща корекции по монтажа, преходите, синхронизирането на музиката и цветовете. Допълнителни ревизии могат да бъдат уговорени отделно.',
  },
  {
    id: 'faq-6',
    question: 'Предлагаш ли абонаментни планове?',
    answer: 'Да! За клиенти, които се нуждаят от регулярно съдържание (напр. месечни пакети за социални медии), AP Media предлага изгодни абонаментни планове с отстъпка. Това гарантира приоритетна изработка.',
  },
  {
    id: 'faq-7',
    question: 'Как да ти изпратя моите кадри?',
    answer: 'Можеш да споделяш файлове чрез Google Drive, WeTransfer, Dropbox или друго облачно пространство. Просто се свържи с AP Media и ще изберем най-лесния начин за трансфер.',
  },
  {
    id: 'faq-8',
    question: 'Как да започнем?',
    answer: 'Лесно е — пиши на AP Media (Alex | Video Editor / Alex Media) на лично съобщение в Instagram или изпрати имейл, описващ проекта ти. Включи типа видео, приблизителната дължина, краен срок и референтни видеа, които харесваш. Ще ти отговоря до 24 часа.',
  },
];
